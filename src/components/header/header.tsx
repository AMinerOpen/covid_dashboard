        ...
        return (
            <div className='header'>
                ...
                <div className='tabs'>
                    ...
                    <div className='tab datasets' onMouseOver={() => this.handleTabHover("")} onClick={() => window.open('https://aminer.cn/data-covid19?lang='+lang, '_blank')}><FormattedMessage id='header.datasets' /></div>
                ...
                <div className='menu' onClick={() => this.setState({showList: !this.state.showList})}><ListSvg /></div>
                {
                    this.state.showList && (
                        <div className='list'>
                            ...
                            <div className='item' onClick={() => window.open('https://aminer.cn/data-covid19?lang='+lang, '_blank')}><FormattedMessage id='header.datasets' /></div>
