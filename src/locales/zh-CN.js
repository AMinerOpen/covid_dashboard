export default {
    ...
    "toolbar.marker": "标记",
    "toolbar.marker.tip": "关闭地图事件marker",
    "toolbar.marker.tip_off": "显示地图事件marker",
    //toolbar.mapMode
    "toolbar.mapmode": "模式",
    ...
    "map.control.suspected": "疑似人数",
    "map.control.active": "现存病例",
    "map.control.serious": "重症人数",
    "map.control.cured": "治愈人数",
    ...
    //forcast
    "forecast.title": "疫情预测",
    "forecast.realtime": "实时数据",
    "forecast.total_confirmed": "累计确诊",
    "forecast.cured": "治愈",
    "forecast.dead": "死亡",
    "forecast.area": "地区",
    "forecast.incr": "确诊新增",
    ...
    //source
    "source.title": "数据源",
    "data.covid_source": "疫情数据",
    "data.scholar_source": "学术数据",
    "data.news_source": "新闻数据",
